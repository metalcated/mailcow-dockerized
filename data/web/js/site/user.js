        ...
        success: function (data) {
          ...
          if (data.sasl) {
            ...
            $.each(data.sasl, function (i, item) {
              ...
              var real_rip = item.real_rip.startsWith("Web") ? escapeHtml(item.real_rip) : '<a href="https://bgp.he.net/ip/' + escapeHtml(item.real_rip) + '" target="_blank">' + escapeHtml(item.real_rip) + "</a>";
