(function() {
  ...
  function configure($mdThemingProvider) {
    ...
    $mdThemingProvider.registerStyles([
      ...
      '}',
      '.sg-message-list-item.sg-star-bg {',
      '  background-color: #3d474f !important;',
      '  box-shadow: inset 3px 0 0 #d7ae3c;',
      '}',
      '.sg-message-list-item.sg-star-bg .sg-md-subhead,',
      '.sg-message-list-item.sg-star-bg .sg-md-body,',
      '.sg-message-list-item.sg-star-bg .sg-tile-date,',
      '.sg-message-list-item.sg-star-bg .sg-tile-size {',
      '  color: #e1e5e8 !important;',
      '}',
      '.sg-message-list-item.sg-star-bg sg-avatar-image md-icon {',
      ...
      '  color: #d0d6db;',
      '}',
      '#detailView.sg-dark-mail-preview .pseudo-input-container--compact a {',
      '  color: #b8c0c7 !important;',
      '}',
      '#detailView.sg-dark-mail-preview .pseudo-input-container--compact md-chip {',
      '  background-color: #46515b !important;',
      '  color: #d0d6db !important;',
      '}',
      ...
      '}',
      '#detailView.sg-light-mail-preview,',
      '#detailView.sg-light-mail-preview .mailer_mailcontent {',
      '  background-color: #f4f5f6;',
      '  color-scheme: light;',
      '}',
      '#detailView.sg-light-mail-preview .sg-face > md-card,',
      '#detailView.sg-light-mail-preview .sg-face > md-card > md-card-content {',
      '  background-color: #f4f5f6 !important;',
      '  color: #252b31 !important;',
      '}',
      '#detailView.sg-light-mail-preview .sg-face > md-card > md-card-actions {',
      '  background-color: #e1e4e7 !important;',
      '  color: #3d474f !important;',
      '}',
      '#detailView.sg-light-mail-preview .sg-face > md-card > md-card-actions md-icon {',
      '  color: #59636c !important;',
      '}',
      '#detailView.sg-light-mail-preview .sg-md-headline,',
      '#detailView.sg-light-mail-preview .pseudo-input-container--compact {',
      '  color: #252b31 !important;',
      '}',
      '#detailView.sg-light-mail-preview .pseudo-input-label,',
      '#detailView.sg-light-mail-preview .msg-date {',
      '  color: #59636c !important;',
      '}',
      '#detailView.sg-light-mail-preview .pseudo-input-container--compact a {',
      '  color: #315f9e !important;',
      '}',
      '#detailView.sg-light-mail-preview .pseudo-input-container--compact md-chip {',
